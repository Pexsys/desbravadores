...
<script type="text/javascript" src="<?php echo $GLOBALS['pattern']->getVD();?>include/_core/js/moment.min.js"></script>
<script type="text/javascript" src="<?php echo $GLOBALS['pattern']->getVD();?>include/_core/js/moment.pt-br.js"></script>
<script type="text/javascript" src="<?php echo $GLOBALS['pattern']->getVD();?>include/_core/js/jstz.min.js"></script>
<script type="text/javascript" src="<?php echo $GLOBALS['pattern']->getVD();?>include/_core/js/jquery.mask.min.js"></script>
...
<script type="text/javascript" src="<?php echo $GLOBALS['pattern']->getVD();?>js/readdata.js<?php echo "?".microtime();?>"></script>
</head>
<body>
<?php
