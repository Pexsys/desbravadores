...
<div class="col-lg-12">
	...
	<div class="row">
		<div class="col-lg-4">
			<button class="btn btn-primary" id="btnNovo"><i class="fas fa-plus"></i>&nbsp;Adicionar Identifica&ccedil;&atilde;o</button>
		</div>
		<div class="col-lg-4">
			<button class="btn btn-danger" id="btnClear" style="display:none"><i class="fas fa-trash-o"></i>&nbsp;Limpar Tudo</button>
			&nbsp;
			<button class="btn btn-warning" id="btnDel" style="display:none"><i class="glyphicon glyphicon-remove"></i>&nbsp;Apagar Linha(s)</button>
		</div>
		<div class="col-lg-4">
			<button class="btn btn-success pull-right" id="btnPrepare" style="display:none"><i class="fas fa-list-alt"></i>&nbsp;Preparar</button>
		</div>
	</div>
</div>
		...
		<div class="modal-dialog"><!---->
			<div class="modal-content">
				...
				<div class="panel-footer">
					<div class="row">
						<div class="col-lg-12">
							<button type="addList" class="btn btn-success pull-right"><i class="fas fa-cart-arrow-down"></i>&nbsp;Colocar na lista</button>
						</div>	
					</div>	
				</div>
			</div>
					...
					<div class="panel panel-warning">
						...
						<div class="panel-body" style="padding:4px 10px 10px">
							...
							<div style="display:none" id="divPageControl">
								<div class="col-lg-12">
									<div class="well well-sm" style="padding:4px;margin-bottom:0px;font-size:11px"><button class="btn btn-default btn-xs" id="btnAddFI"><i class="fas fa-plus"></i></button>&nbsp;<b>P&aacute;gina Incompleta</b></div>
