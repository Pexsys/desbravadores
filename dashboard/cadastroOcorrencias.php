								...
								<div class="panel-body">
									<div class="row">
										...
										<div class="form-group col-xs-2">
											...
											<input type="checkbox" name="fgPend" id="fgPend" field="fg_pend" value-on="N" value-off="S" data-toggle="toggle" data-onstyle="success" data-offstyle="warning" data-on="<i class='fas fa-gavel'></i>&nbsp;<b>EFETIVADO</b>" data-off="<i class='fas fa-pencil-alt'></i>&nbsp;RASCUNHO" data-size="small" data-width="120"/>
										</div>
									</div>
									<div class="row">
...
<script src="<?php echo PATTERNS::getVD();?>dashboard/js/cadastroOcorrencias.js<?php echo "?".microtime();?>"></script>