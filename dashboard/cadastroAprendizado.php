...
<div class="col-lg-12">
		...
		array( 
			...
			"filters" => 
				array( 
					...
					array( "id" => "HA", "ds" => "Avaliações", "icon" => "fas fa-thermometer-half" ),
	...
	<div class="row">
		...
		&nbsp;
		<button class="btn btn-success" id="btnDigital"><i class="fas fa-barcode"></i>&nbsp;Digital</button>
		&nbsp;
		<button class="btn btn-danger" id="btnDelAprend"><i class="fas fa-trash-o"></i>&nbsp;Excluir</button>
	</div>
</div>
