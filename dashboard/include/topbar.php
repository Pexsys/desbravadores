<nav class="navbar navbar-inverse navbar-static-top" role="navigation" style="margin:0">
	<ul class="nav navbar-top-links navbar-right">
		<li class="dropdown" id="notifyTasks" style="display:none">
			<a class="dropdown-toggle" data-toggle="dropdown" href="#" style="color:#777777">
				<i class="fas fa-tasks fa-fw"></i><span id="notifyTasksBadge" style="display:none"><span class="badge badge-notify"></span></span><i class="fas fa-caret-down"></i>
			</a>
