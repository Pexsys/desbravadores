...
<link href="<?php echo $GLOBALS['pattern']->getVD();?>include/_core/css/sb-admin-2.css" rel="stylesheet"/>
<link href="<?php echo $GLOBALS['pattern']->getVD();?>include/_core/css/morris.css" rel="stylesheet"/>
<link href="<?php echo $GLOBALS['pattern']->getVD();?>include/_core/css/datatable/dataTables.bootstrap.min.css" rel="stylesheet"/>
<link href="<?php echo $GLOBALS['pattern']->getVD();?>include/_core/css/datatable/jquery.dataTables.min.css" rel="stylesheet"/>
<link href="<?php echo $GLOBALS['pattern']->getVD();?>include/_core/css/calendar.min.css" rel="stylesheet"/>
<style>
.badge-notify{
   background:#cc0000;
   position:relative;
...
<script src="<?php echo $GLOBALS['pattern']->getVD();?>include/_core/js/bootstrap-datetimepicker.min.js"></script>
...
<script src="<?php echo $GLOBALS['pattern']->getVD();?>include/_core/js/slimscroll/jquery.slimscroll.min.js"></script>
<script src="<?php echo $GLOBALS['pattern']->getVD();?>include/_core/js/datatable/jquery.dataTables.min.js"></script>
<script src="<?php echo $GLOBALS['pattern']->getVD();?>include/_core/js/datatable/dataTables.tableTools.min.js"></script>
<script src="<?php echo $GLOBALS['pattern']->getVD();?>include/_core/js/datatable/dataTables.bootstrap.min.js"></script>
<script src="<?php echo $GLOBALS['pattern']->getVD();?>include/_core/js/datatable/dataTables.buttons.min.js"></script>
<script src="<?php echo $GLOBALS['pattern']->getVD();?>include/_core/js/datatable/ZeroClipboard.js"></script>
<script src="<?php echo $GLOBALS['pattern']->getVD();?>include/_core/js/datatable/datetime-moment.js"></script>
