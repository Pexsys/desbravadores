...
function dashboard(id, fData){
    ...
    function histoGram(fD){
        ...
        var y = d3.scaleLinear().rangeRound([hGDim.h, 0])
        ...
        bars.append("rect")
            ...
            .on("mouseover",function(d){  
                ...
                var st = fData.filter(function(s){ return s.Aprend == d[0];})[0],
    ...
    function pieChart(pD){
        ...
        var arc = d3.arc().outerRadius(pieDim.r-40).innerRadius(0);
        ...
        piesvg.selectAll("path")
            ...
            .on("mouseover",function mouseover(d){
                ...
                hG.update(fData.map(function(v){ 
                    return [v.Aprend,v.freq[d.data.type],v.color];}));
            })
            ...
            .on("mouseout",function mouseout(d){
                ...
                hG.update(fData.map(function(v){
                    return [v.Aprend,v.total,v.color];}));
            })
        ;
    ...
    function legend(lD){
        ...
        tr.append("td").text(function(d){ return segLegend(d.type); });
    ...
    var sF = fData.map(function(d){return [d.Aprend,d.total,d.color];});
