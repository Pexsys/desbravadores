<div class="row">
	<div class="col-lg-12">
		<h3 class="page-header">Tabela de UF</h3>
	</div>
</div>
<div class="col-lg-2">
	<div class="row">
						...
						<div class="col-lg-12">
							<div class="panel panel-warning" aria-expanded="false">
								<div class="panel-heading">
									...
									<h3 class="panel-title"><b>UF</b></h3>
								</div>
...
<script src="<?php echo $GLOBALS['VirtualDir'];?>dashboard/js/tabelaUF.js<?php echo "?".microtime();?>"></script>