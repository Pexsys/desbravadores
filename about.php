...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <p style="text-align:justify">Atravessamos enchentes, documentos e materiais perdidos, roubos, brigas, separações, sanções administrativas, mas o importante é que o Clube Pioneiros continua a desenvolver seu trabalho desde sua fundação. Mesmo quando não oficial, os membros se reuniam escondidos nas casas de alguns pais, tamanho o amor a esse ministério e às atividades.</p>
            </div>
        </div>
        <br/>
        <br/>
            ...
            <div class="col-md-4 text-center">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <p>Utilizada pelos "escoteiros adventistas"<br/>no ano de início das atividades</p>
                    </div>
                </div>
            </div>
            <div class="col-md-4 text-center">
