<?php
$batismo = FILTERS::getDomain( array( "type" => "B" ) );
$eventos = FILTERS::getDomain( array( "type" => "EV" ) );
$unidades = FILTERS::getDomain( array( "type" => "U" ) );
$classes = FILTERS::getDomain( array( "type" => "C" ) );
?>
<div class="row">
	<div class="col-lg-12">
...
<div class="row">
	<div class="col-lg-8">
		<select name="cbListagem" id="cbListagem" class="selectpicker form-control input-sm" title="Escolha uma Listagem" data-width="100%" data-container="body" data-actions-box="true">
			...
			<option data-icon="fas fa-heart" show="divVegetariano" value="geraListaVegetarianos.php?filter=">LISTAGEM DE MEMBROS - VEGETARIANOS</option>
			<option data-divider="true"></option>
