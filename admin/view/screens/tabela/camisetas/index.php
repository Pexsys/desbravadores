<div class="row">
	<div class="col-lg-12">
		<h3 class="page-header">Tabela de Tamanhos/Modelos de Camisetas</h3>
	</div>
</div>
<div class="row">
	<div class="col-lg-2">
							...
							<div class="col-lg-12">
								<div class="panel panel-warning" aria-expanded="false">
									<div class="panel-heading">
										...
										<h3 class="panel-title"><b>Camisetas</b></h3>
									</div>
...
<script src="<?php echo PATTERNS::getVD();?>admin/view/screens/tabela/camisetas/index.js<?php echo "?".time();?>"></script>
