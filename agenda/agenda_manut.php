	...
	if ($ACAO == "NEW" || $ACAO == "EDIT"):
		...
		<form name=frmAgenda id=frmAgenda method="post" action="<?php echo $o->PHPDomain . $VirtualDir?>agenda/agenda_manut.php">
			<table width="100%" border="0" cellpadding="5" cellspacing="1" valign="top">
				...
				<tr>
					<td valign=top><span class="style1"><strong>Data/Hora In�cio:</strong>                    
				...
				<tr>
					<td valign=top><span class="style1"><strong>N�mero:</strong>                    
				...
				<tr>
					<td valign=top><span class="style5">Informa��es Adicionais:</span><br>					  <textarea name=INFO_ADIC id=INFO_ADIC cols=100 rows=10><?php echo $row->INFO_ADIC;?></TEXTAREA></td>
				</tr>
				<tr>
