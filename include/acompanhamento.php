...
function fGetDetailAcomp($class, $titulo, $icon, $result){
	$str = "";
	if (!$result->EOF):
		$str .= "<div class=\"col-lg-6 col-sm-6 col-xs-6\">";
		$str .= "<div class=\"row\">";
		...
		foreach ($result as $k => $line):
			...
			$str .= "<div class=\"row\">";
			$str .= "  <div class=\"col-lg-6 col-sm-6 col-xs-6\" style=\"padding:1px 0px 2px 15px\" title=\"$hint\">";
			...
			$str .= "  </div>";
			$str .= "  <div class=\"col-lg-6 col-sm-6 col-xs-6\" style=\"padding:1px 30px 2px 10px\">";
