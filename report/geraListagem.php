...
class LISTAGEM extends TCPDF {
	...
	public function Footer() {
 	...
 	public function Header() {
		...
		$this->setXY(20,5);
		if ($this->unidade["TP"] == "F"):
			$this->SetTextColor(107,11,13);
			$this->SetFillColor(107,11,13);
		elseif ($this->unidade["TP"] == "M"):
			$this->SetTextColor(15,81,34);
			$this->SetFillColor(15,81,34);
		else:
			$this->SetTextColor(80,80,80);
			$this->SetFillColor(80,80,80);
		endif;
		$this->SetFont(PDF_FONT_NAME_MAIN, 'B', 25);
		$this->Cell(185, 9, "Controle de Presença da Unidade", 0, false, 'C', false, false, false, false, 'T', 'M');
		$this->setXY(20,16);
