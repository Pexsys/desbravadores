...
class LISTAEVENTOALFA extends TCPDF {
	...
	public function Footer() {
 	...
 	public function Header() {
		...
		$this->Cell(185, 6, "LISTAGEM PARA CONTROLE DE AUTORIZAÇÕES - ALFABÉTICA", 0, false, 'C', false, false, false, false, 'T', 'M');
		$this->posY += 8;
	...
	public function download() {
		$this->lastPage();
		$this->Output("ListagemParticipantesAutoriz_".date('Y-m-d_H:i:s').".pdf", "I");
	}
}
