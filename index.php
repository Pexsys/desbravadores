...
?>
 <div class="col-md-4">
	<div class="card">
		<div class="header bg-red"><h4><i class="fa fa-fw fa-calendar"></i>&nbsp;Pr&oacute;ximos Eventos</h4></div>
		<div class="body">
			<div class="row">
				<div class="col-md-12">
				<?php
...
?>
    <div class="col-md-4">
    	<div class="card">
    		<div class="header bg-green"><h4><i class="fa fa-fw fa-bullhorn"></i>&nbsp;Conheça a Unidade</h4></div>
    		<div class="body">
	    		<?php
...
function about(){
	...
	<div class="col-md-4">
		<div class="card">
			<div class="header bg-light-blue"><h4><i class="fa fa-fw fa-history"></i>&nbsp;Voltando no tempo...</h4></div>
			<div class="body">
				<div class="row">
					<div class="col-md-12">
...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
			...
			<div class="col-md-4">
				<div class="card">
					<div class="header bg-blue"><h4><i class="fa fa-fw fa-file-text"></i>&nbsp;Capas de Especialidades</h4></div>
					<div class="body">
						<div class="row">
							<div class="col-md-12">
								...
								<a class="btn bg-blue pull-right" href="capas.php" role="button">Gerar Capas</a></p>
							</div>
						</div>
					</div>
				</div>
				<div class="card">
					<div class="header bg-indigo"><h4><i class="fa fa-fw fa-film"></i>&nbsp;V&iacute;deos</h4></div>
					<div class="body">
						<div class="row">
							<div class="col-md-12">
								<div class="media">
			...
			<div class="col-md-4">
			<?php echo fListDocumentos("docs/outros/","<h4><i class=\"fa fa-fw fa-pencil\"></i>&nbsp;Outros Documentos</h4>",".doc;.docx;.xls;.xlsx;.pdf;","bg-grey","h5");?>
			</div>
		</div>
        <!-- /.row -->
